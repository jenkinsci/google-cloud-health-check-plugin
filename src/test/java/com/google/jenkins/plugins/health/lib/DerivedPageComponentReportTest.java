...
/**
 * Unit test for {@link DerivedPageComponentReport}.
 */
public class DerivedPageComponentReportTest {
  @Test
  public void getters() {
    DerivedPageComponentReport report = new DerivedPageComponentReport<String>(
